...
public class ServiceResponse {
    private static Retrofit.Builder retrofitBuilder = new Retrofit.Builder().baseUrl("https://smartflowerpot.azurewebsites.net/swagger/index.html").addConverterFactory(GsonConverterFactory.create());
